...
//Route::post('/customers/registration', 'HomeController@registration_store')->name('user.registration.store');
Route::post('/customers/login', 'HomeController@user_login')->name('user.login.submit');
Route::get('/customers/login/otp', 'HomeController@user_login_otp')->name('user.login.otp');
Route::post('/customers/login/verify', 'HomeController@user_login_verify')->name('user.login.verify');
Route::post('/customers/login/cart', 'HomeController@cart_login')->name('cart.login.submit');
Route::get('/customers/login/cartotp', 'HomeController@cart_login_otp')->name('cart.login.otp');
Route::post('/customers/login/verifycart', 'HomeController@cart_login_verify')->name('cart.login.verify');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    // inquires message
    Route::post('/inquiry', 'ConversationController@inquiry_store')->name('inquiry.store');
    Route::get('/inquiry/index', 'ConversationController@inquiry_index')->name('inquiry.index');
    Route::get('/inquiry/{id}/show', 'ConversationController@inquiry_show')->name('inquiries.admin_show');
    Route::get('/inquiry/{id}/destroy', 'ConversationController@inquiry_destroy')->name('inquiries.admin_destroy');
