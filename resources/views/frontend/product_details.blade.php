                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 mb-4">
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            <div class="col-12 order-2  mt-3 mt-md-0">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-secondary buy-now fw-600 sm_button_style" onclick="product_inquery_modal()">
                                    <i class="la la-shopping-cart"></i> {{ translate('Product Inquiry')}}
                                </button>
                            </div>
...
@section('modal')
    ...
    <!--modal for product inquary-->
    
    <div class="modal fade" id="product_inquery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title fw-600 h5">{{ translate('Any Inquiry about this product')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form class="" action="{{ route('inquiry.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body gry-bg px-3 pt-3">
                        
                        <div class="form-group">
                            <input type="hidden" name="product_id"  value="{{ $detailedProduct->id }}">
                            <input type="text" disabled  class="form-control mb-3" value="Product Id: {{ $detailedProduct->id }}">
                        </div>
                        
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="name"  placeholder="{{ translate('Enter Your  Name') }}" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="email"  placeholder="{{ translate('example@example.com') }}" required>
                        </div>
                        
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="phone"  placeholder="{{ translate('Enter Phone Number (017********)') }}" required>
                        </div>
                        
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required placeholder="{{ translate('Your Question') }}" placeholder="Your Message"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-primary fw-600" data-dismiss="modal">{{ translate('Cancel')}}</button>
...
@section('script')
    <script type="text/javascript">
        ...
        function product_inquery_modal(){
            @if (Auth::check())
                $('#product_inquery').modal('show');
            @else
                $('#login_modal').modal('show');
            @endif
        }
